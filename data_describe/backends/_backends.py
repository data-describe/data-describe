...
def _check_backend(
    ...
    if backend_type in loaded_backends:
        if module is None:
            ...
            if str(module.__path__) in loaded_backends[backend_type]:  # type: ignore mypy #5059 # mypy issue 1422
                return True
    return False
...
def _add_backend(backend_type: str, loaded_backends: dict, module: ModuleType):
    ...
    loaded_backends[backend_type][str(module.__path__)] = module  # type: ignore mypy #5059 # mypy issue 1422
