...
def load_data(filepath, all_folders=False, **kwargs):
    ...
    Args:
        filepath: The file path. Can be either a local filepath or
        Google Cloud Storage URI filepath
        all_folders: If True, searches for text files in nested folders.
        If False, looks for text files in the current folder
...
def download_gcs_file(filepath, bucket=None, prefix=None, **kwargs):
    ...
    Args:
        ...
        prefix: parameter in list_blobs to limit the results to objects
