...
TEXT_DATA = {
    ...
    "test_list_digits": [["th3is", "is", "8", "a", "d1s4ster", "but", "no", "numb3rs"]],
    ...
    "answer_key_remove_stopwords": [["please", "eat", "rest", "pineapple", "pizza"]],
    ...
    "answer_key_custom": [["THIS", "IS", "AN", "ABSOLUTELY", "PHENOMENAL", "DAY", "."]],
}
