...
#     fixture.check(os.path.join(EXEC_CWD, 'examples', 'Data_Loader.ipynb'), raise_errors=True)


# def test_distributions_notebook():
#     fixture.check(os.path.join(EXEC_CWD, 'examples', 'Distributions.ipynb'), raise_errors=True)


# def test_auto_data_type_notebook():
#     fixture.check(os.path.join(EXEC_CWD, 'examples', 'Auto Data Type.ipynb'), raise_errors=True)
